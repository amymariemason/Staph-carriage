...
* different from Danny_dataextract as does not drop extraneous data, but carries it all along.
...
save "E:\users\amy.mason\Staph\Danny_data_extra", replace

export delimited using "E:\users\amy.mason\Staph\Danny_data_staph_extra", quote replace
